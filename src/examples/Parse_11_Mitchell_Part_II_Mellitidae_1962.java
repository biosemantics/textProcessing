 ...
 * @author iychoi
 */
public class Parse_11_Mitchell_Part_II_Mellitidae_1962 {
    ...
    public Parse_11_Mitchell_Part_II_Mellitidae_1962(String processor_name) {
    ...
    private HierarchyEntry genHierarchyEntry(String taxonNameInfo) throws IOException {
        ...
        String rank = "Species";
        if(taxonName.split("\\s").length == 3) {
            rank = "Species";
        } else if(taxonName.split("\\s").length == 2) {
            rank = "Genus";
        }
        ...
        for(Paragraph paragraph : paragraphs) {
            switch(paragraph.getType()) {
                case PARAGRAPH_TITLE:
                {
                    ...
                    taxonomy.setTaxonName("MELLITIDAE");
                    
                    HierarchyEntry hierarchy_entry = getHierarchyEntry("MELLITIDAE", "Family");
    ...
    public static void main(String[] args) throws Exception {
        Parse_11_Mitchell_Part_II_Mellitidae_1962 obj = new Parse_11_Mitchell_Part_II_Mellitidae_1962("Illyoung Choi");
        obj.start(14);
    }
}
