 ...
 * @author iychoi
 */
public class Parse_OCR_19_Proshchalykin_Lelej_2010 {
    ...
    public Parse_OCR_19_Proshchalykin_Lelej_2010(String processor_name) {
    ...
    private HierarchyEntry genHierarchyEntry(String taxonNameInfo) throws IOException {
        ...
        if (rank == null) {
            ...
            if (rankRemoved.endsWith(" n. sp.")) {
                ...
                rank = "Subgenus";
            } else if (rankRemoved.equals("Nomada roberjeotiana")) {
                rank = "Species_group";
        ...
        for (Paragraph paragraph : paragraphs) {
            switch (paragraph.getType()) {
                case PARAGRAPH_TITLE: {
                    HierarchyEntry hierarchy_entry_nomada = getHierarchyEntry("Nomada", "Genus");
                    hierarchy.addEntry(hierarchy_entry_nomada);
                    break;
                }
                case PARAGRAPH_TAXONNAME: {
                    String taxonname = paragraph.getContent();
                    if(taxonname.equals("The Nomada roberjeotiana species-group")) {
                        taxonname = "Nomada roberjeotiana";
                    }
    ...
    public static void main(String[] args) throws Exception {
        Parse_OCR_19_Proshchalykin_Lelej_2010 obj = new Parse_OCR_19_Proshchalykin_Lelej_2010("Illyoung Choi");
        obj.start(24);
    }
}
