 ...
 * @author iychoi
 */
public class Parse_OCRed_15_Snelling_1986 {
    ...
    public Parse_OCRed_15_Snelling_1986(String processor_name) {
    ...
    private String getTaxonName(String nameInfo) {
        ...
        if(nameInfo.equals("UNASSIGNED SPECIES OF HYPOCHROTAENIA")) {
            return "Hypochrotaenia";
        }
    ...
    private HierarchyEntry genHierarchyEntry(String taxonNameInfo) throws IOException {
        ...
        if (rank == null) {
            ...
            if(taxonNameInfo.endsWith(" new subgenus")) {
                rank = "Subgenus";
            } else if(taxonNameInfo.equals("UNASSIGNED SPECIES OF HYPOCHROTAENIA")) {
                rank = "Genus";
            } else {
        ...
        for (Paragraph paragraph : paragraphs) {
            switch (paragraph.getType()) {
                case PARAGRAPH_TITLE: {
                    HierarchyEntry hierarchy_entry_nomada = getHierarchyEntry("NOMADINI", "Tribe");
                    ...
                    taxonomy.setTaxonName("Nomadini");
                    
                    HierarchyEntry hierarchy_entry = getHierarchyEntry("Nomadini", "Tribe");
    ...
    public static void main(String[] args) throws Exception {
        Parse_OCRed_15_Snelling_1986 obj = new Parse_OCRed_15_Snelling_1986("Illyoung Choi");
        obj.start(28);
    }
}
