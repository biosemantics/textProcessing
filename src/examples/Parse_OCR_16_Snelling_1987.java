 ...
 * @author iychoi
 */
public class Parse_OCR_16_Snelling_1987 {
    ...
    public Parse_OCR_16_Snelling_1987(String processor_name) {
    ...
    private String getAuthority(String name) {
        if(name.equals("Melanomada species A") || name.equals("Melanomada species B")) {
            return null;
        }
    ...
    private HierarchyEntry genHierarchyEntry(String taxonNameInfo) throws IOException {
        ...
        if (rank == null) {
            ...
            if (rankRemoved.endsWith(" n. sp.")) {
                ...
                rank = "Variety";
            } else if(rankRemoved.equals("Melanomada Cockerell")) {
                rank = "Genus";
            }
        ...
        for (Paragraph paragraph : paragraphs) {
            switch (paragraph.getType()) {
                case PARAGRAPH_TITLE: {
                    HierarchyEntry hierarchy_entry_melanomada = getHierarchyEntry("MELANOMADA", "Genus");
                    hierarchy.addEntry(hierarchy_entry_melanomada);
                    
                    taxonomy = TaxonXMLCommon.createNewTaxonomy();
                    // set metadata
                    TaxonXMLCommon.addNewMeta(taxonomy, this.processor_name, document.getFilename());
                    taxonomy.setTaxonName("Melanomada");
                    
                    HierarchyEntry hierarchy_entry = getHierarchyEntry("Melanomada", "Genus");
    ...
    public static void main(String[] args) throws Exception {
        Parse_OCR_16_Snelling_1987 obj = new Parse_OCR_16_Snelling_1987("Illyoung Choi");
        obj.start(22);
    }
}
