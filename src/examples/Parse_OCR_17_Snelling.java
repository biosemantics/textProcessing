 ...
 * @author iychoi
 */
public class Parse_OCR_17_Snelling {
    ...
    public Parse_OCR_17_Snelling(String processor_name) {
    ...
    public static void main(String[] args) throws Exception {
        Parse_OCR_17_Snelling obj = new Parse_OCR_17_Snelling("Illyoung Choi");
        obj.start(23);
    }
}
