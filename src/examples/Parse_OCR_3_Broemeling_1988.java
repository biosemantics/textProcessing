 ...
 * @author iychoi
 */
public class Parse_OCR_3_Broemeling_1988 {
    ...
    public Parse_OCR_3_Broemeling_1988(String processor_name) {
        ...
        for (Paragraph paragraph : paragraphs) {
            switch (paragraph.getType()) {
                ...
                case PARAGRAPH_TAXONNAME: {
                    // exception
                    if (paragraph.getContent().endsWith(" Group") && !paragraph.getContent().equals("Vincta Group")) {
                        break;
                    }
                    ...
                    if (paragraph.getContent().equals("Vincta Group")) {
                        taxonomy.setTaxonName("Vincta");
                        HierarchyEntry hierarchy_entry = getHierarchyEntry("Vincta", "Species_group");
    ...
    public static void main(String[] args) throws Exception {
        Parse_OCR_3_Broemeling_1988 obj = new Parse_OCR_3_Broemeling_1988("Illyoung Choi");
        obj.start(17);
    }
}
